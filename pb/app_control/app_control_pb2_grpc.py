...
from pb.app_control import app_control_pb2 as app__control_dot_app__control__pb2
...
class AppControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChangeMicrophoneStatus = channel.unary_unary(
                ...
                request_serializer=app__control_dot_app__control__pb2.ChangeMicrophoneStatusRequest.SerializeToString,
...
def add_AppControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ChangeMicrophoneStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=app__control_dot_app__control__pb2.ChangeMicrophoneStatusRequest.FromString,
...
class AppControl(object):
    ...
    def ChangeMicrophoneStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/app_control.AppControl/ChangeMicrophoneStatus',
            app__control_dot_app__control__pb2.ChangeMicrophoneStatusRequest.SerializeToString,
